...
import com.amazon.alexa.sdk.callbacks.AsyncCallback;
import com.amazon.alexa.sdk.callbacks.AuthorizationCallback;
import com.amazon.alexa.sdk.data.Event;
import com.amazon.alexa.sdk.interfaces.AvsException;
import com.amazon.alexa.sdk.interfaces.AvsItem;
import com.amazon.alexa.sdk.interfaces.AvsResponse;
import com.amazon.alexa.sdk.interfaces.GenericSendEvent;
import com.amazon.alexa.sdk.interfaces.audioplayer.AvsPlayAudioItem;
import com.amazon.alexa.sdk.interfaces.response.ResponseParser;
import com.amazon.alexa.sdk.interfaces.speechrecognizer.SpeechSendAudio;
import com.amazon.alexa.sdk.interfaces.speechrecognizer.SpeechSendText;
import com.amazon.alexa.sdk.interfaces.speechrecognizer.SpeechSendVoice;
import com.amazon.alexa.sdk.interfaces.speechsynthesizer.AvsSpeakItem;
import com.amazon.alexa.sdk.requestbody.DataRequestBody;
import com.amazon.alexa.sdk.service.DownChannelService;
import com.amazon.alexa.sdk.system.AndroidSystemHandler;
import com.amazon.alexa.sdk.utility.Util;
...
import static com.amazon.alexa.sdk.AuthorizationManager.createCodeVerifier;
import static com.amazon.alexa.sdk.interfaces.response.ResponseParser.getBoundary;
import static com.amazon.alexa.sdk.utility.Util.IDENTIFIER;
...
public class AlexaManager {
    ...
    /**
     * Send a synchronize state {@link Event} request to Alexa Servers to retrieve pending {@link com.amazon.alexa.sdk.data.Directive}
     ...
     * See: {@link #sendEvent(String, AsyncCallback)}
     *
     * @param volume volume as reported by the {@link com.amazon.alexa.sdk.interfaces.speaker.AvsAdjustVolumeItem} Directive
     ...
     * See: {@link #sendEvent(String, AsyncCallback)}
     *
     * @param isMute mute state as reported by the {@link com.amazon.alexa.sdk.interfaces.speaker.AvsSetMuteItem} Directive
     * @param callback
     */
    ...
    /**
     * Send a generic event to the AVS server, this is generated using {@link com.amazon.alexa.sdk.data.Event.Builder}
