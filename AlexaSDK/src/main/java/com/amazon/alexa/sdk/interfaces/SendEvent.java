...
public abstract class SendEvent {
     ...
     * @param url the URL we're posting to, this is either the default {@link com.amazon.alexa.sdk.data.Directive} or {@link com.amazon.alexa.sdk.data.Event} URL
    ...
    /**
     * Get our JSON {@link com.amazon.alexa.sdk.data.Event} for this call
     * @return the JSON representation of the {@link com.amazon.alexa.sdk.data.Event}
     */
    @NotNull
